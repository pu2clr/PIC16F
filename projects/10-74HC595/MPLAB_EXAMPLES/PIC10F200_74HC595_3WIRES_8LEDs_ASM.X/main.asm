...
; The PIC10F200 and 74HC595 interface uses three wires     
...
; beginsTransaction - Disable output
beginTransaction MACRO 
  bsf GPIO, 2	    ; Set (turn on) bit 2 of GPIO (HIGH)
  call Delay100us    
ENDM		     


; endTransaction - Enable output
endTransaction MACRO 
  bcf GPIO, 2	    ; Clear (turn on) bit 2 of GPIO (LOW)
  call Delay100us    
ENDM		    
