...
; Thus, an elapsed time of 830 탎 means that the distance traveled was approximately 10 cm (you may need calibrate it).   
; An elapsed time of 2450 탎 means that the distance traveled was approximately 30 cm (you may need calibrate it).
ReadHCS04: 
...
;************** Delay functions *************      
; At 4 MHz, one instruction takes 1탎
; So, this soubroutine should take about 10탎 
